...
using Service.PaymentProviderRouter.Modules;
using Service.PaymentProviderRouter.Services;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.PaymentProviderRouter
{
	public class Startup
	{
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			{
				endpoints.MapGrpcSchema<PaymentProviderRouterService, IPaymentProviderRouterService>();
